...
class HomeView:UIView {
    ...
    private var containertTopConstraint: NSLayoutConstraint!
    ...
    private func setupConstraints() {
        ...
        containertTopConstraint = containerView.topAnchor.constraint(equalTo: mapView.bottomAnchor, constant:  -16)
        containertTopConstraint.isActive = true
    ...
    private func handlePanGesture(_ gesture: UIPanGestureRecognizer){
        ...
        switch gesture.state {
            case .changed:
                let newConstant = containertTopConstraint.constant + translation.y
                if newConstant <= 0 && newConstant >= frame.height * 0.5 {
                    containertTopConstraint.constant = newConstant
            ...
            case .ended:
                ...
                UIView.animate(withDuration: 0.3, animations: {
                    self.containertTopConstraint.constant = finalPosition
                    self.layoutIfNeeded()
                })
            default:
                break
