...
class DetailsViewController: UIViewController {
    ...
    private func applyLateralConstraints(to views: [UIView]){
        views.forEach { view in
            view.leadingAnchor.constraint(equalTo: self.containerView.leadingAnchor, constant: 24).isActive = true
            view.trailingAnchor.constraint(equalTo: self.containerView.trailingAnchor, constant: -24).isActive = true
        }
    }
